...
The first group of baseline models we choose are the PPO, TD3, and SAC model described in section 3. After training, we found our best training reward is around 350. And evaluation reward is 347.975. [TODO]
...
1. The first model we trained as baseline is a PPO model trained on environment that only contains straight road. The training curve for this model is showed below and the evaluation episodic reward is [TODO].

2. The second model we trained as baseline is a PPO model trained on environment that only contains intersections. The training curve for this model is showed below and the evaluation episodic reward is [TODO].

3. The third model we trained as baseline is a PPO model trained on environment that only contains Circular and Roundabouts. The training curve for this model is showed below and the evaluation episodic reward is [TODO].

We then train the selection model based on these three baseline models. The training curve for this model is showed below and the evaluation episodic reward is [TODO].

[TODO: Analyzation and Visualization]

### 4.4 Ensemble Different PPO Models Trained on Different Traffic Situations
...
#### 4.4.4 Results for Specialized models
...
#### 4.4.5 Results for Generalized models
...
{: style="margin-left: auto; margin-right: auto; max-width: 70%; text-align: center"}
*Fig 8. Training Curve for a single PPO model.*
{: style="text-align: center"}
...
{: style="margin-left: auto; margin-right: auto; max-width: 70%; text-align: center"}
*Fig 9. Training Curve for training weight-selection model with specialized submodels.*
{: style="text-align: center"}
...
{: style="margin-left: auto; margin-right: auto; max-width: 70%; text-align: center"}
*Fig 10. Training Curve for training weight-selection model with generalized submodels.*
{: style="text-align: center"}
...
*Fig 11. Visualization of Performance of a Single PPO agent.*
{: style="text-align: center"}
...
{: style="margin-left: auto; margin-right: auto; max-width: 100%; text-align: center"}
*Fig 12. Visualization of Performance of Averaging Ensemble over generalized models.*
{: style="text-align: center"}
...
{: style="margin-left: auto; margin-right: auto; max-width: 100%; text-align: center"}
*Fig 13. Visualization of Performance of PPO weight-selction Ensemble over generalized models.*
{: style="text-align: center"}
...
{: style="margin-left: auto; margin-right: auto; max-width: 100%; text-align: center"}
*Fig 14. Visualization of Performance of Averaging Ensemble over specialized models.*
{: style="text-align: center"}
...
{: style="margin-left: auto; margin-right: auto; max-width: 100%; text-align: center"}
*Fig 15. Visualization of Performance of PPO weight-selction Ensemble over specialized models.*
{: style="text-align: center"}
...
{: style="margin-left: auto; margin-right: auto; max-width: 100%; text-align: center"}
*Fig 16. Performance and corresponding output weight of PPO weight-selction Ensemble over specialized models on 4-lane heavy-traffic scenario.*
{: style="text-align: center"}
...
{: style="margin-left: auto; margin-right: auto; max-width: 100%; text-align: center"}
*Fig 17. Performance and corresponding output weight of PPO weight-selction Ensemble over specialized models on 2-lane heavy-traffic scenario.*
{: style="text-align: center"}
...
{: style="margin-left: auto; margin-right: auto; max-width: 100%; text-align: center"}
*Fig 18. Performance and corresponding output weight of PPO weight-selction Ensemble over specialized models on 2-lane light-traffic scenario.*
{: style="text-align: center"}
